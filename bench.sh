...
turbobench=/nix/store/g5596cjjrg0c7pl7yaqnbfhzn1cg2zvs-turbobench-2023-03/bin/turbobench

testfile=unpacked-zips.tar
...
set -x
$turbobench $testfile -e$e "$@"

exit

/nix/store/g5596cjjrg0c7pl7yaqnbfhzn1cg2zvs-turbobench-2023-03

exit

/nix/store/vik1gwprwhbbfxk2hz515nksmxyxxalc-turbobench-2023-03/bin/turbobench unpacked-zips.tar -eFAST
...
zstd
brotli
rar: proprietary archive format
